...
async function getAllAnimeInfo() {
	try {
		const response = await fetch(`http://localhost:3000/anime_info`);
...
async function getAnimeInfo(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getCharacter(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/character/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getGenre(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/genre/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getProducer(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/producer/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getStaff(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/staff/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getStudio(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/studio/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
...
async function getTrailer(anime_name) {
	try {
		const response = await fetch(
			`http://localhost:3000/anime_info/trailer/${anime_name}`
		);
		const data = await response.json();
		return data;
	} catch (error) {
	...
	try {
		...
		for (let i = 0; i < 3; i++) {
			...
			document.getElementById(`sys${i}`).textContent =
				animeData[i].synopsis.substring(0, 400) + "...";
			document
...
async function loadAnimeInfo() {
	...
	<div class="info-item">
		...
		//synopsis
		html = `<p>${animeData[0].synopsis}</p>`;
		document.getElementById("synopsis").innerHTML = html;
